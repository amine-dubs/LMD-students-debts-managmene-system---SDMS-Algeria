...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 22, 2024 at 04:20 PM
...
--
CREATE DATABASE IF NOT EXISTS `debt_management` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `debt_management`;
...
INSERT INTO `enrolls` (`EnrollID`, `StudentID`, `TeacherID`, `CourseID`, `Note`, `Section`, `Groupe`, `Type`) VALUES
(25, 59, 38, 24, NULL, 1, 2, 1);
...
(33, 'studentFN', 'studentLN', 33),
(34, 'teacherFN', 'teacherLN', 34);
...
(1, 1, 'admin', 'admin'),
(33, 4, 'student', 'student'),
(34, 2, 'teacher', 'teacher');
...
ALTER TABLE `admins`
  ...
  ADD KEY `admins_ibfk_1` (`PersonID`);
...
--
ALTER TABLE `cycles`
  MODIFY `CycleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `enrolls`
--
ALTER TABLE `enrolls`
  MODIFY `EnrollID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `responsables`
  MODIFY `ResponsableID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `semesters`
--
ALTER TABLE `semesters`
  MODIFY `SemesterID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `teachers`
  MODIFY `TeacherID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
('root', '[{\"db\":\"debt_management\",\"table\":\"semesters\"},{\"db\":\"debt_management\",\"table\":\"responsables\"},{\"db\":\"debt_management\",\"table\":\"students\"},{\"db\":\"debt_management\",\"table\":\"courses\"},{\"db\":\"debt_management\",\"table\":\"admins\"},{\"db\":\"debt_management\",\"table\":\"types\"},{\"db\":\"debt_management\",\"table\":\"users\"}]');
...
('root', '2024-05-10 16:46:30', '{\"Console\\/Mode\":\"collapse\"}');
